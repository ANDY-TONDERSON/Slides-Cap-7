...
background: '#0a5'
---
<section data-background="/Slides-Cap-7/images/mediosTransimision.jpg" data-transition="zoom-in">
...
<section data-transition="zoom-in" data-background="/Slides-Cap-7/images/TMS.png">
...
<section data-transition="fade-in" data-background="/Slides-Cap-7/images/clasificación de medios de transmisión.png">
...
<section data-background="/Slides-Cap-7/images/pii.jpg">
...
<section data-transition="convex-in" data-background="/Slides-Cap-7/images/image.png">
    <div style="background-color: rgba(255,255,255,0.9); padding: 30px; border-radius: 20px;">
        <p style="color: #333;">Los medios guiados, que son aquellos que proporcionan un conducto de un dispositivo a otro, incluyen el cable de par trenzado, el cable coaxial y el cable de fibra óptica.</p>
    </div>
</section>
...
<section data-background="linear-gradient(45deg, #2c3e50, #3498db)">
    <div style="background-color: rgba(255,255,255,0.95); padding: 25px; border-radius: 15px;">
        ...
        <img src="/Slides-Cap-7/images/i3.png" alt="Internal Image" style="border: 3px solid #3498db;">
...
<section data-background="linear-gradient(60deg, #553c9a, #b393d3)">
    <div style="background-color: rgba(255,255,255,0.95); padding: 25px; border-radius: 15px;">
        ...
        <img src="/Slides-Cap-7/images/i4.png" alt="Internal Image" style="border: 3px solid #553c9a;">
    </div>
</section>
...
<section data-background="linear-gradient(120deg, #2980b9, #2c3e50)">
    <div style="background-color: rgba(255,255,255,0.95); border-radius: 15px;">
        ...
        <img src="/Slides-Cap-7/images/i5.png" alt="Internal Image" style="border: 3px solid #2980b9;">
    </div>
</section>
...
<section data-background="linear-gradient(45deg, #00416A, #799F0C)">
    <div style="background-color: rgba(255,255,255,0.95); padding: 25px; border-radius: 15px;">
        ...
        <img src="/Slides-Cap-7/images/i6.png" alt="Internal Image" style="border: 3px solid #00416A;">
    </div>
</section>
...
<section data-background="linear-gradient(135deg, #1e3c72, #2a5298)">
    <div style="background-color: rgba(255,255,255,0.9); padding: 30px; border-radius: 20px;">
        <img src="/Slides-Cap-7/images/i7.png" alt="Internal Image" style="display: block; margin: 20px auto; border-radius: 10px;">
    </div>
</section>

<section data-background="/Slides-Cap-7/images/CPT.jpg">
    <div style="background-color: rgba(255,255,255,0.9); padding: 30px; border-radius: 20px;">
...
<section data-background="linear-gradient(135deg, #8e44ad, #3498db)">
    <div style="background-color: rgba(255,255,255,0.9); padding: 30px; border-radius: 20px;">
        ...
        <img src="/Slides-Cap-7/images/i8.png" alt="Internal Image" style="display: block; margin: 20px auto; border-radius: 10px;">
    </div>
</section>
...
<section data-background="linear-gradient(120deg, #e74c3c, #2c3e50)">
    <div style="background-color: rgba(255,255,255,0.9); padding: 30px; border-radius: 20px;">
        ...
        <img src="/Slides-Cap-7/images/i9.png" alt="Internal Image" style="display: block; margin: 20px auto; border-radius: 10px;">
    </div>
</section>
...
<section data-background="linear-gradient(135deg, #8e44ad, #3498db)">
    <div style="background-color: rgba(255,255,255,0.9); padding: 30px; border-radius: 20px;">
        ...
        <img src="/Slides-Cap-7/images/i10.png" alt="Internal Image" style="display: block; margin: 20px auto; border-radius: 10px;">
...
<section data-background="linear-gradient(120deg, #e74c3c, #2c3e50)">
    <div style="background-color: rgba(255,255,255,0.9); padding: 30px; border-radius: 20px;">
        ...
        <img src="/Slides-Cap-7/images/i11.png" alt="Internal Image" style="display: block; margin: 20px auto; border-radius: 10px;">
    </div>
</section>

<section data-background="/Slides-Cap-7/images/ECC.jpg">
    <div style="background-color: rgba(255,255,255,0.9); padding: 30px; border-radius: 20px;">
...
<section data-background="linear-gradient(120deg, #2C3E50 0%, #3498DB 100%)">
    <div style="background-color: rgba(255,255,255,0.9); padding: 30px; border-radius: 20px;">
        ...
        <img src="/Slides-Cap-7/images/pii.jpg" alt="Internal Image" style="border: 3px solid #3498DB;">
    </div>
</section>
...
<section data-background="linear-gradient(135deg, #f39c12, #e67e22)">
    <div style="background-color: rgba(255,255,255,0.9); padding: 30px; border-radius: 20px;">
        ...
        <img src="/Slides-Cap-7/images/i12.png" alt="Internal Image" style="display: block; margin: 20px auto; border-radius: 10px;">
    </div>
</section>

<section data-background="linear-gradient(135deg, #f39c12, #e67e22)">
    <div style="background-color: rgba(255,255,255,0.9); padding: 30px; border-radius: 20px;">
        <h3 style="color: #004e92;">Modos de Propagación</h3>
...
<section data-background="linear-gradient(135deg, #3498db, #2980b9)">
    <div style="background-color: rgba(255,255,255,0.9); padding: 30px; border-radius: 20px;">
       <img src="/Slides-Cap-7/images/i13.png" alt="Internal Image" style="display: block; margin: 20px auto; border-radius: 10px;">
   </div>
</section>
...
<section data-background="linear-gradient(135deg, #e67e22, #d35400)">
    <div style="background-color: rgba(255,255,255,0.9); padding: 30px; border-radius: 20px;">
        ...
        <img src="/Slides-Cap-7/images/i15.png" alt="Internal Image" style="display: block; margin: 20px auto; border-radius: 10px;">
    </div>
</section>
...
<section data-background="linear-gradient(135deg, #2ecc71, #27ae60)">
    <div style="background-color: rgba(255,255,255,0.9); padding: 30px; border-radius: 20px;">
        ...
        <img src="/Slides-Cap-7/images/i16.png" alt="Internal Image" style="display: block; margin: 20px auto; border-radius: 10px;">
    </div>
</section>
...
<section data-background="linear-gradient(135deg, #8e44ad, #71368a)">
    <div style="background-color: rgba(255,255,255,0.9); padding: 30px; border-radius: 20px;">
        ...
        <img src="/Slides-Cap-7/images/i17.png" alt="Internal Image" style="display: block; margin: 20px auto; border-radius: 10px;">
    </div>
</section>
...
<section data-background="linear-gradient(135deg, #e74c3c, #c0392b)">
    <div style="background-color: rgba(255,255,255,0.9); padding: 30px; border-radius: 20px;">
        ...
        <img src="/Slides-Cap-7/images/i18.png" alt="Internal Image" style="display: block; margin: 20px auto; border-radius: 10px;">
    </div>
</section>

<section data-background="/Slides-Cap-7/images/EFO.png">
    <div style="background-color: rgba(255,255,255,0.9); padding: 30px; border-radius: 20px;">
        <h2 style="color: #1abc9c;">Aplicaciones</h2>
...
<section data-background="/Slides-Cap-7/images/MNG.png">
...
<section data-background="linear-gradient(135deg, #f39c12, #e67e22)">
    <div style="background-color: rgba(255,255,255,0.9); padding: 30px; border-radius: 20px;">
        ...
        <img src="/Slides-Cap-7/images/micro.jpg" alt="Internal Image" style="display: block; margin: 20px auto; border-radius: 10px;">
    </div>
</section>
...
<section data-background="linear-gradient(135deg, #8e44ad, #71368a)">
    <div style="background-color: rgba(255,255,255,0.9); padding: 30px; border-radius: 20px;">
        ...
        <img src="/Slides-Cap-7/images/i21.png" alt="Internal Image" style="display: block; margin: 20px auto; border-radius: 10px;">
    </div>
</section>
...
<section data-background="linear-gradient(135deg, #e67e22, #d35400)">
    <div style="background-color: rgba(255,255,255,0.9); padding: 30px; border-radius: 20px;">
        ...
        <img src="/Slides-Cap-7/images/i22.png" alt="Internal Image" style="display: block; margin: 20px auto; border-radius: 10px;">
    </div>
</section>

<section data-background="/Slides-Cap-7/images/j1.jpg">
    <div style="background-color: rgba(255,255,255,0.9); padding: 30px; border-radius: 20px;">
...
<section data-background="linear-gradient(135deg, #f39c12, #e67e22)">
    <div style="background-color: rgba(255,255,255,0.9); padding: 30px; border-radius: 20px;">
        <h2 style="color: #f39c12;">Clasificación de Ondas Electromagnéticas</h2>
        <h3 style="color: #e67e22;">Ondas de Radio:</h3>
        <ul style="color: #34495e; list-style-type: disc; padding-left: 20px;">
...
<section data-background="linear-gradient(135deg, #2980b9, #3498db)">
    <div style="background-color: rgba(255,255,255,0.9); padding: 30px; border-radius: 20px;">
        ...
        <img src="/Slides-Cap-7/images/i23.png" alt="Internal Image" style="display: block; margin: 20px auto; border-radius: 10px;">
    </div>
</section>

<section data-background="/Slides-Cap-7/images/mondas.jpg">
    <div style="background-color: rgba(255,255,255,0.9); padding: 30px; border-radius: 20px;">
...
<section data-background="linear-gradient(135deg, #e67e22, #d35400)">
    <div style="background-color: rgba(255,255,255,0.9); padding: 30px; border-radius: 20px;">
       <img src="/Slides-Cap-7/images/img32.png" alt="Internal Image" style="display: block; margin: 20px auto; border-radius: 10px;">
    </div>
</section>
...
<section data-background="/Slides-Cap-7/images/ii.jpg">
    <div style="background-color: rgba(255,255,255,0.9); padding: 30px; border-radius: 20px;">
        <h2 style="color: #1abc9c;">Aplicaciones</h2>
...
<section data-background="linear-gradient(135deg, #c0392b, #e74c3c)">
    <div style="background-color: rgba(255,255,255,0.9); padding: 30px; border-radius: 20px;">
        <h2 style="color: #c0392b;">Infrarojo</h2>
        <img src="/Slides-Cap-7/images/iii.jpg" alt="Internal Image" style="display: block; margin: 20px auto; border-radius: 10px;">
    </div>
</section>
...
<section data-background="linear-gradient(135deg, #2980b9, #3498db)">
    <div style="background-color: rgba(255,255,255,0.9); padding: 30px; border-radius: 20px;">
        ...
        <img src="/Slides-Cap-7/images/iiii.jpg" alt="Internal Image" style="display: block; margin: 20px auto; border-radius: 10px;">
    </div>
</section>
